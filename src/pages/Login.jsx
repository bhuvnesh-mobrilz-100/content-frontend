  ...
  return (
    <div className="max-w-md mx-auto mt-10 animate-fadeIn">
      <div className="bg-white p-8 rounded-xl shadow-sm border animate-slideUp">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="animate-fadeIn stagger-2">
            ...
            <div className="relative">
              <input type={showPassword ? 'text' : 'password'} value={password} onChange={(e) => setPassword(e.target.value)} required placeholder="Enter your password" className="w-full px-3 py-2.5 pr-10 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none hover:border-blue-300" />
        ...
        <p className="text-center text-sm text-gray-500 mt-6 animate-fadeIn stagger-3">
